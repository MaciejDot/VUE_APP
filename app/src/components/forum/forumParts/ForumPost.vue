...
<div style="padding:5px;margin-bottom:30px">
  ...
  <b-media style="position:relative;min-height:500px;">
   <div style="text-align:center;float:left;display:inline;height:30px; margin-top:6px">{{author}}<div v-if="edited!=null">edited on {{edited}}</div></div>
   
    <svg 
      style="max-width:30px;float:right;opacity:0.5;cursor:pointer"
      viewBox="0 0 90 90">
      <path d="m 13 45 a 1 1 0 0 0 15 0 a 1 1 0 0 0 -15 0 z m 25 0 a 1 1 0 0 0 15 0 a 1 1 0 0 0 -15 0 z m 25 0 a 1 1 0 0 0 15 0 a 1 1 0 0 0 -15 0 z "/>
    </svg>
